...
public class RevealColorView extends ViewGroup
{
    ...
    public void reveal(final int x, final int y, final int color, final int startRadius, long duration,
                    final Animator.AnimatorListener listener)
    {
        ...
        animator = inkView.animate().scaleX(finalScale).scaleY(finalScale).setDuration(duration)
    ...
    public void hide(final int x, final int y, final int color, final int endRadius, final long duration,
                    final Animator.AnimatorListener listener)
    {
